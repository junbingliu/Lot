...
import {CANCEL_DETAIL_URL,COUPON_LIST_URL,RECEIVE_COUPON_URL,COUPON_USER_URL,WX_SHARE_LINK_API,LOT_RD,LOT_DURATION} from "../../consts";
...
export default class lotteryCp extends Component{
    ...
    constructor(){
        super();
        this.state={running:false, Q:5, r:LOT_RD,d:LOT_DURATION}
    }
    ...
    getAg(a,q,r){
        ...
        switch (a) {
            case 0:return 2*180*r;
            case 1:return 180*(1/(-q)+2*r);
            default:return 180*((1+2*(a-1))/(-q)+2*r);
        }
    }
    ...
    rotateFn(a,Q,r,d,txt){
        let self=this;
        let ag = self.getAg(a,Q,r);
